...
<html>
    ...
    <body>
        <a href="#create-playerFile" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-playerFile" class="content scaffold-create" role="main">
            ...
            <!--  Errors from the playerFile save here.  -->
    ...
    <%--
            <g:form resource="${this.playerFile}" method="POST">
                <fieldset class="form">
