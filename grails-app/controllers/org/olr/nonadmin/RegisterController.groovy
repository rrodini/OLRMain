...
// set the custom properties
            ...
            def user = uiPropertiesStrategy.setProperties(
                    ...
                    org: registerCommand.org,
                    orgAddress: registerCommand.orgAddress,
                    orgCity: registerCommand.orgCity,
                    orgState: registerCommand.orgState,
                    orgZip: registerCommand.orgZip,
                    User,
                    null)
